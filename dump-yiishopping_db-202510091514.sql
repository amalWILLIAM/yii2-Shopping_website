...
INSERT INTO `cart` VALUES (1,9,1759834088,1759834088),(2,1,1759919513,1759919513);
...
CREATE TABLE `cart_item` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx-cart_item-unique` (`cart_id`,`product_id`),
  KEY `fk-cart_item-product_id` (`product_id`),
  CONSTRAINT `fk-cart_item-cart_id` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk-cart_item-product_id` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE
...
CREATE TABLE `order` (
  ...
  `payment` varchar(50) DEFAULT 'cash_on_delivery',
  PRIMARY KEY (`id`),
...
INSERT INTO `order` VALUES (2,9,544979.00,'pending',1759917099,1759917099,NULL,NULL,'cash_on_delivery'),(3,9,120000.00,'pending',1759917147,1759917147,NULL,NULL,'cash_on_delivery'),(4,9,75000.00,'placed',1759917737,1759917737,NULL,NULL,'cash_on_delivery'),(5,1,112334.00,'placed',1759920901,1759920901,NULL,NULL,'cash_on_delivery'),(6,1,64999.00,'placed',1759920926,1759920926,NULL,NULL,'cash_on_delivery'),(7,1,64999.00,'Confirmed',1759924570,1759924570,NULL,NULL,'cash_on_delivery'),(8,9,65000.00,'Confirmed',1759926412,1759926412,NULL,NULL,'cash_on_delivery'),(9,9,55000.00,'Confirmed',1759982116,1759982116,NULL,NULL,'cash_on_delivery'),(10,9,55000.00,'Confirmed',1759982568,1759982568,'pa dsd sadas ds','7034269922','cash on delivery'),(11,9,110000.00,'Confirmed',1760002638,1760002638,'fdgdfg','7034269922','cash on delivery');
...
INSERT INTO `order_item` VALUES (1,2,7,1,64999.00,NULL,NULL,'cash on delivery'),(2,2,8,2,239990.00,NULL,NULL,'cash on delivery'),(3,3,5,1,120000.00,NULL,NULL,'cash on delivery'),(4,4,3,1,75000.00,NULL,NULL,'cash on delivery'),(5,5,11,1,112334.00,NULL,NULL,'cash on delivery'),(6,6,7,1,64999.00,NULL,NULL,'cash on delivery'),(7,7,7,1,64999.00,NULL,NULL,'cash on delivery'),(8,8,2,1,65000.00,NULL,NULL,'cash on delivery'),(9,9,1,1,55000.00,'panickassery house dimon mukku','7034269922','cash on delivery'),(10,10,1,1,55000.00,NULL,NULL,'cash on delivery'),(11,11,1,2,55000.00,NULL,NULL,'cash on delivery');
...
-- Dump completed on 2025-10-09 15:14:43
